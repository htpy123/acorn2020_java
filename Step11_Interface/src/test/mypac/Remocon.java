...
public interface Remocon {
	...
	public static final String COMPANY = "LG";   //참조 방법은 Remocon.COMPANY   static 영역에 infield가 올라감
//	public String COMPANY = "LG"; 생략가능 어차피 static final 자동 부여
	//메소드 (abstract 예약어 생략 가능)
	public abstract void up();
	public abstract void down();
//	public void left(); //abstract 예약어 생략 가능
//	public void test() {}; 에러 발생
}
